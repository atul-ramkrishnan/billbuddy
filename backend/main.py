...
client = motor.motor_asyncio.AsyncIOMotorClient("mongodb+srv://admin:admin@cluster0.odieqyw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client.billbuddy
...
class Item(BaseModel):
    ...
    name: str = Field(...)
    cost: float = Field(ge=0.0, description="The cost of the item in USD.")
...
class UserModel(BaseModel):
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "example": {
                "name": "Jane Doe",
                "items": [{"name": "Item 1", "cost": 10.0}, {"name": "Item 2", "cost": 20.0}]
            }
        },
    )
