...
// mapStateToProps is a function that takes the entire Redux store state and the component's own props,
// and returns an object with the parts of the state that the component needs.
const mapStateToProps = (state: IAppState | undefined, ownProps: any) => {
    return {
        people: state ? Person.getListItems(state.people) : [],
        activeId: state ? state.selectedPersonId : null
    }
};
// mapDispatchToProps is a function that takes the Redux dispatch function and the component's own props,
// and returns an object with functions that the component can use to dispatch actions.
